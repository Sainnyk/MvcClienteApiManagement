...
string urlEmpleados = builder.Configuration.GetValue<string>("ApiUrls:ApiEmpleados");

string urlDept = builder.Configuration.GetValue<string>("ApiUrls:ApiDepartamentos");
ServiceApiManagement service = new ServiceApiManagement(urlEmpleados, urlDept);
